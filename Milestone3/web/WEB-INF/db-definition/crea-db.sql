...
create table news(
    ...
    foreign key (autore) references users(idUser) on update cascade on delete cascade
);
...
create table comments(
    ...
    foreign key (autore) references users(idUser) on update cascade on delete cascade,
    foreign key (idNotizia) references news(idNews) on update cascade on delete cascade
);
