        ...
        try (PrintWriter out = response.getWriter()){
            ...
            /*In caso di utente non loggato, e si accede alla servlet tramite il form di login.jsp,
              vengono acquisiti email/username e password*/
                ...
                if (name != null && password != null && UserFactory.loginEmail(name, password)){
                    //email e password esistono e sono validi
                    int userId = UserFactory.getUserByEmail(name).getId();
                ...
                else if (name != null && password != null && UserFactory.loginUsername(name, password)){
                    //username e password esistono e sono validi
                    int userId = UserFactory.getUserByUsername(name).getId();
                    session.setAttribute("userId", userId);
                    session.setAttribute("loggedIn", true);
