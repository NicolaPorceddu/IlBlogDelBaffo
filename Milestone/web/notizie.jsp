    ...
    <body>
        ...
        <main id="articolo">
            ...
            <c:forEach var="news" items="${newsList}">
                <a href="notizia.html?nid=${news.id}"><h2 class="corsivo">${news.titolo}</h2></a>

                <div class="anteprima">
                    <a href="notizia.html?nid=${news.id}">
                        <img class="imgAnteprima" title="${news.didascalia}" alt="Immagine articolo" src="M1/${news.img}" width="600" height="337">
                    </a>
                    <div>
