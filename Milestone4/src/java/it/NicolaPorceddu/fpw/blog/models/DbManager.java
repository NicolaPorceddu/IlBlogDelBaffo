...
public class DbManager {
    ...
    private DbManager(){
        try{// Si carica a run-time la classe del Driver
        ...
        // Se si dovesse arrivare qui senza eccezioni,
        // è possibile connettersi al DB
    }
    ...
    public Connection getDbConnection(){
        String db = "jdbc:mysql://ec2-52-47-198-123.eu-west-3.compute.amazonaws.com:443/fpw18_porceddunicola?zeroDateTimeBehavior=convertToNull";

        try{
            // creazione e apertura della connessione
            // si specifica la url, lo username e la password per il db
            Connection conn = DriverManager.getConnection(db, "fpw18_porceddunicola", "NicolaPorceddu");
            return conn;
