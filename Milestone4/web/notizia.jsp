...
<html lang="it">
    ...
    <body>
        ...
        <main id="articolo">
            ...
            <img class="imgArticolo" title="${news.didascalia}" alt="Immagine articolo" src="${news.img}" width="600" height="337">
            ...
            <c:forEach var="comment" items="${commentList}">
                <div class="anteprima">
                    <img title="Immagine del profilo" alt="Immagine del profilo" src="${comment.utente.urlProfImg}" width="100" height="100">
